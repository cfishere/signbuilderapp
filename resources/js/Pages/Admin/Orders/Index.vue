...
function updatePerPage(value: number) {
  router.get('/admin/orders', { ...localFilters, per_page: value }, { preserveState: true, preserveScroll: true });
}

function applyFilters() {
  router.get('/admin/orders', { ...localFilters, per_page: perPage.value }, { preserveState: true, preserveScroll: true });
}

function clearFilters() {
  localFilters.order_number = '';
  localFilters.owner = '';
  localFilters.date_from = '';
  localFilters.date_to = '';
  router.get('/admin/orders', { per_page: perPage.value }, { preserveState: true, preserveScroll: true });
}
    ...
    <div class="max-w-6xl mx-auto py-8">
      <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
          ...
          <p class="text-sm text-gray-600">Admin view across all customers.</p>
        </div>
