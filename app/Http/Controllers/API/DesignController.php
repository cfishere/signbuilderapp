...
class DesignController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'sign_width'    => 'nullable|numeric|min:1',
            'sign_height'   => 'nullable|numeric|min:1',
            'sign_depth'    => 'nullable|numeric|min:1',

            'canvas_width'  => 'required|numeric|min:1',
            'canvas_height' => 'required|numeric|min:1',
            'grid_size'     => 'nullable|numeric|min:1',
    ...
    public function update(Request $request, Design $design)
    {
        ...
        $validated = $request->validate([
            ...
            'sign_width'    => 'sometimes|nullable|numeric|min:1',
            'sign_height'   => 'sometimes|nullable|numeric|min:1',
            'sign_depth'    => 'sometimes|nullable|numeric|min:1',

            'canvas_width'  => 'sometimes|numeric|min:1',
            'canvas_height' => 'sometimes|numeric|min:1',
            'grid_size'     => 'sometimes|nullable|numeric|min:1',
